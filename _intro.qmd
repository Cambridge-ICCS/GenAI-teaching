...
- **Gradient descent**
  move weights down the loss surface
- **Backpropagation**
  compute gradients layer by layer
- **Overfitting**
  memorises training data, fails to generalise
:::
::: {.column width="50%"}
```{mermaid}
...
## Transformers: Inference {.smaller auto-animate=true}
...
:::
::: {.column width="55%"}
![](images/tfp-step0a.png){width="75%" style="margin-left: 2em;" data-id="inference-img"}
:::
::::
...
:::
::: {.column width="55%"}
![](images/tfp-step0b.png){width="75%" style="margin-left: 2em;" data-id="inference-img"}
:::
::::
...
::: {.column width="45%"}
- **Tokenise** text → sub-word token IDs
- Token IDs enter the **LLM**
:::
::: {.column width="55%"}
![](images/tfp-step1-alternate.png){width="75%" style="margin-left: 2em;" data-id="inference-img"}
:::
::::
...
- **Tokenise** text → sub-word token IDs
- Token IDs enter the **LLM**
- **Embed + pos. encoding** token IDs → dense vectors with position
:::
::: {.column width="55%"}
![](images/tfp-step2-alternate.png){width="75%" style="margin-left: 2em;" data-id="inference-img"}
:::
::::
...
:::
::: {.column width="55%"}
![](images/tfp-step4-alternate.png){width="75%" style="margin-left: 2em;" data-id="inference-img"}
:::
::::
...
- **Embed + pos. encoding** token IDs → dense vectors with position
- **Self-attention + MLP** × N layers every token attends to every other
- **Predict & sample** logits → softmax → sample
:::
::: {.column width="55%"}
![](images/tfp-step5-alternate.png){width="75%" style="margin-left: 2em;" data-id="inference-img"}
:::
::::
...
:::
::: {.column width="55%"}
![](images/tfp-step6-alternate.png){width="75%" style="margin-left: 2em;" data-id="inference-img"}
:::
::::
...
:::
::: {.column width="55%"}
![](images/tfp-step7-alternate.png){width="75%" style="margin-left: 2em;" data-id="inference-img"}
:::
::::
...
A key point RSEs: the LLM itself is stateless:all state lives in the context window. The "loop" is managed by the surrounding application code, not the model.
:::
