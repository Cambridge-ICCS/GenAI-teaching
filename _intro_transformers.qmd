...
::: {.notes}
This has profound implications for how you use LLMs. Long conversations get expensive because the full history is re-processed every time. 

Context length limits are a hard constraint.

 Techniques like RAG, summarisation, and memory modules are all workarounds for this fundamental limitation.
:::
